import { Accordion, AccordionDetails, AccordionSummary, Box, Chip, Paper, Stack, Toolbar, Typography } from "@mui/material";
...
export default function DescriptionPanel() {
  ...
  return (
    <Box component={Paper} sx={{ display: 'flex', flexDirection: 'column', height: '100%', overflowY: 'hidden' }}>
      ...
      <Stack sx={{ gap: 1, py: 1, px: 2, overflowY: 'scroll' }}>
